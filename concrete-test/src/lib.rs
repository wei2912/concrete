...
//!
//! This application contains generic testing functions, aimed at verifying that the statistical properties
//! of the operators implemented in `concrete_core` follow our models (embodied by the formulas implemented in
//! `concrete_npe`)
//!
//! The generic nature of the test functions implemented here, makes it possible to test every operators of
//! the `concrete-core` library, using the same functions. Then, testing a new backend mainly consists in
//! appropriately instantiating the tests.
//!
//! # Test architecture
//!
...
/// + Convert back and forth between prototypical entities and actual entity type used for the tests.
pub struct Maker {
