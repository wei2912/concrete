...
//!
//! For all the tests present in this application, we need to be able to generate input plaintext, and analyze
//! output plaintexts. We implement those generation and analysis function only for the _raw_ `u32` and `u64`
//! types.
//!
...
//! + Statistical analysis of the properties of messages after the operation (see [`statistical_test`])
//!
