...
use crate::synthesizing::synthesizers::{
    ...
    SynthesizableBinaryLweSecretKey, SynthesizableCleartextVector, SynthesizablePlaintext,
};
...
use concrete_core::prelude::{
    LweCiphertextCleartextDiscardingMultiplicationEngine, LweCiphertextDiscardingKeyswitchEngine,
    LweCiphertextEncryptionEngine, LweCiphertextEntity, LweSecretKeyEntity, PlaintextEntity,
};
use lazy_static::lazy_static;

pub fn test_binary<Precision, Engine, InputCiphertext, Cleartext, OutputCiphertext>()
where
    ...
    Cleartext: SynthesizableCleartextVector<Precision>,
