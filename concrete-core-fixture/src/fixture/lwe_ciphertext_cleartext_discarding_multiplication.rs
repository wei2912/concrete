...
/// A fixture for the types implementing the `LweCiphertextCleartextDiscardingMultiplicationEngine` trait.
        ...
        + SynthesizesLweCiphertext<Precision, OutputCiphertext>,
{
    ...
    type RawInputs = (Precision::Raw, Precision::Raw);
    type RawOutputs = (Precision::Raw,);
    type Bypass = (<Maker as PrototypesLweSecretKey<Precision, InputCiphertext::KeyDistribution>>::LweSecretKeyProto, );
    ...
    fn generate_random_raw_inputs(_parameters: &Self::Parameters) -> Self::RawInputs {
        (
            ...
            Precision::Raw::uniform_zero_centered(1024),
        )
    }
