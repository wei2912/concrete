        ...
        + SynthesizesLweCiphertext<Precision, Ciphertext>,
{
    ...
    type Bypass = (<Maker as PrototypesLweSecretKey<Precision, Ciphertext::KeyDistribution>>::LweSecretKeyProto, );
    ...
    fn prepare_context(
        ...
        let proto_ciph = maker.trivial_encrypt_plaintext_to_lwe_ciphertext(
        ...
        let synth_ciphertext = maker.synthesize_lwe_ciphertext(&proto_ciph);
        (
            (proto_secret_key,),
            (synth_plaintext, synth_secret_key, synth_ciphertext),
        )
    }
