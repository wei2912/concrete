...
use concrete_core::prelude::{
    DestructionEngine, LweSecretKey32, LweSecretKey64, LweSecretKeyEntity,
};
...
impl SynthesizesLweSecretKey<Precision32, LweSecretKey32> for Maker {
    fn synthesize_lwe_secret_key(&mut self, prototype: &Self::LweSecretKeyProto) -> LweSecretKey32 {
        prototype.0.to_owned()
    }

    fn unsynthesize_lwe_secret_key(&mut self, entity: &LweSecretKey32) -> Self::LweSecretKeyProto {
...
impl SynthesizesLweSecretKey<Precision64, LweSecretKey64> for Maker {
    fn synthesize_lwe_secret_key(&mut self, prototype: &Self::LweSecretKeyProto) -> LweSecretKey64 {
        prototype.0.to_owned()
    }

    fn unsynthesize_lwe_secret_key(&mut self, entity: &LweSecretKey64) -> Self::LweSecretKeyProto {
