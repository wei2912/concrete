...
//!
//! The central abstraction of this (private) library, is the [`Fixture`](fixture::Fixture) trait which, once
//! implemented for a given engine trait, exposes method to sample/test/benchmark any implementor of the
//! engine trait in question.
