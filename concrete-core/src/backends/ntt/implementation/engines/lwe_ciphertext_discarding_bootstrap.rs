...
use crate::backends::ntt::implementation::engines::NttEngine;
use crate::backends::ntt::implementation::entities::{
    ...
    > for NttEngine
{
    ...
    ///     ntt_engine.create_lwe_bootstrap_key(&lwe_sk, &glwe_sk, dec_bl, dec_lc, noise)?;
