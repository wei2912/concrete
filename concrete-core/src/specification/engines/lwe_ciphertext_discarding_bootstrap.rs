...
/// |\vec{s}\_{\mathsf{in}}|$ and $n\_{\mathsf{out}} = |\vec{s}\_{\mathsf{out}}|$, such that the noise
/// in this latter is set to a fixed (reduced) amount. It requires a
...
/// \mathsf{ct}\_{\mathsf{out}} \in \mathsf{LWE}^{n\_{\mathsf{out}}}\_{\vec{s}\_{\mathsf{out}}} \left(
/// \mathsf{pt} \right)$$
///
/// ## Algorithm
/// ###### inputs:
