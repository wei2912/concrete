...
///
/// Let $\vec{S}\_{\mathsf{out}} = (S\_{\mathsf{out},0}, \ldots, S\_{\mathsf{out},k\_{\mathsf{out}}-1})
/// \in \mathcal{R}^{k\_{\mathsf{out}}}$, such that $S\_{\mathsf{out},i} =
/// \sum\_{j=0}^{N\_{\mathsf{out}}-1} s\_{\mathsf{out},i, j} \cdot X^j$. Then, the extracted LWE key
/// will be $\vec{s}\_{\mathsf{out}} = (s\_{\mathsf{out},0,0}, \ldots,
/// s\_{\mathsf{out},0,N\_{\mathsf{out}}-1}, \ldots, s\_{\mathsf{out},k\_{\mathsf{out}}-1,0}, \ldots,
/// s\_{\mathsf{out},k\_{\mathsf{out}}-1,N\_{\mathsf{out}}-1}) \in \mathbb{Z}^{n\_{\mathsf{out}}}$,
/// where $n\_{\mathsf{out}} = k\_{\mathsf{out}} \cdot N\_{\mathsf{out}}$.
